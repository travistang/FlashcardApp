...
class ParseHelperTest {
    ...
    fun testParseEntry() {
        ...
        assertNotNull(entry)
        assertTrue(entry is Verb)
        assertTrue((entry as Verb).perfect == "versprochen")
    }
